...
class RepositoryMakeCommand extends GeneratorCommandBase
{
    ...
    protected function bindInterface($name)
    {
        ...
        $key = '/* NEW BINDING */';
        $bind = '\\App\\Repositories\\'.$className.'::class => \\App\\Repositories\\Impls\\'.$className.'Impl::class,'.PHP_EOL.'        '.$key;
    ...
    protected function getInterfacePath($name)
    {
        ...
        return $this->laravel['path'].'/Repositories/'.$className.'.php';
    }
    ...
    protected function getRepositoryPath($name)
    {
        ...
        return $this->laravel['path'].'/Repositories/Impls/'.$className.'Impl.php';
    }
